# Target: sub_0804FCA0 (cvaos GBA, agbcc) — FRESH asm function

Source asm TU: asm/code/code_08040A38.s (do NOT edit it)
Your candidate (standalone TU): ai_gba/scratch/agent_sub_0804FCA0.c
Address: 0x804fca0
Oracle (run from /Users/chrislamark/projects/recomp/nds_recompiler/ai-assisted-decomp/cvaos):
  ../st/.venv/bin/python tools_ai/gbamatch.py --src ai_gba/scratch/agent_sub_0804FCA0.c --func sub_0804FCA0
...
## Callees (bl targets)
sub_08002200 — signatures: grep them in src/*.c and include/.
