# Target: sub_080698A8 (cvaos GBA, agbcc) — FRESH asm function

Source asm TU: asm/code/code_08060B98.s (do NOT edit it)
Your candidate (standalone TU): ai_gba/scratch/agent_sub_080698A8.c
Address: 0x80698a8
Oracle (run from /Users/chrislamark/projects/recomp/nds_recompiler/ai-assisted-decomp/cvaos):
  ../st/.venv/bin/python tools_ai/gbamatch.py --src ai_gba/scratch/agent_sub_080698A8.c --func sub_080698A8
...
## Callees (bl targets)
sub_08001C1C, sub_08001D94, sub_08002058, sub_0800207C, sub_0806D430, sub_0806D460 — signatures: grep them in src/*.c and include/.
