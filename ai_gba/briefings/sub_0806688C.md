# Target: sub_0806688C (cvaos GBA, agbcc) — FRESH asm function

Source asm TU: asm/code/code_08060B98.s (do NOT edit it)
Your candidate (standalone TU): ai_gba/scratch/agent_sub_0806688C.c
Address: 0x806688c
Oracle (run from /Users/chrislamark/projects/recomp/nds_recompiler/ai-assisted-decomp/cvaos):
  ../st/.venv/bin/python tools_ai/gbamatch.py --src ai_gba/scratch/agent_sub_0806688C.c --func sub_0806688C
...
## Callees (bl targets)
PlaySong, sub_08067660 — signatures: grep them in src/*.c and include/.
