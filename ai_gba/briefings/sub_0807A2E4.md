# Target: sub_0807A2E4 (cvaos GBA, agbcc) — FRESH asm function

Source asm TU: asm/code/code_080709D8.s (do NOT edit it)
Your candidate (standalone TU): ai_gba/scratch/agent_sub_0807A2E4.c
Address: 0x807a2e4
Oracle (run from /Users/chrislamark/projects/recomp/nds_recompiler/ai-assisted-decomp/cvaos):
  ../st/.venv/bin/python tools_ai/gbamatch.py --src ai_gba/scratch/agent_sub_0807A2E4.c --func sub_0807A2E4
...
## Callees (bl targets)
sub_0803F2C8, sub_08069A00, sub_0806B120, sub_0806CF2C, sub_0806CFFC — signatures: grep them in src/*.c and include/.
