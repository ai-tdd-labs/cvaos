# Target: sub_0803AAEC (cvaos GBA, agbcc) — FRESH asm function

Source asm TU: asm/code/code_08039340.s (do NOT edit it)
Your candidate (standalone TU): ai_gba/scratch/agent_sub_0803AAEC.c
Address: 0x803aaec
Oracle (run from /Users/chrislamark/projects/recomp/nds_recompiler/ai-assisted-decomp/cvaos):
  ../st/.venv/bin/python tools_ai/gbamatch.py --src ai_gba/scratch/agent_sub_0803AAEC.c --func sub_0803AAEC
...
## Callees (bl targets)
sub_08000C28, sub_0803943C, sub_0803D924 — signatures: grep them in src/*.c and include/.
