...
/**
 * @brief 370F0 | Debug player-entity update: samples collision around the
 * entity, prints collision flags/positions to the BG command buffer, then runs
 * a two-state (init / active) movement state machine with input-driven
 * horizontal motion, jumping and gravity, and finally updates camera and OAM.
 *
 * NOT MATCHED YET - best attempt below is 15 halfwords off (size correct,
 * 0x648). Both remaining diff windows (+0x224..0x232 and +0x322..0x336) are
 * pure register-number permutations of the correct instruction sequence:
 *   +0x224 (case 1 entry): ROM does ldr r0,=gEwramData; ldr r1,[r0];
 *     mov r8,r0 (early), we get ldr r2/ldr r0 with mov r8,r2 sunk to the end
 *     of the block. FAKE `+= 0`, pointer-local, `*&g`, and register-keyword
 *     variants all canonicalize to the identical (wrong-reg) encoding.
 *   +0x322 (unk_52A += (sp20==0)?temp_sl:sp20): ROM ties the sum to r0
 *     (adds r0,r2,r0) and puts the zero in r2; we get adds r1,r2,r0 / zero
 *     in r0. Introducing any typed temp for the ternary changes the stack
 *     frame (sp20 loses its spill slot, function shrinks 8 bytes), so the
 *     direct ternary form is structurally right.
 * See https://decomp.me/scratch/UoIYN (99.63%).
 *
 * @param param_0 Entity data
 */
#ifdef AI_ATTEMPT_SUB_080370F0 /* 15 halfwords off - kept for reference */
static inline s32 sub_080370F0_inline_0(s32 val)
{
    return val & 0x2;
}

static inline s32 sub_080370F0_inline_1(s32 val)
{
    return val & 0xC0;
}
...
/**
 * @brief 370F0 | Debug player-entity update: samples collision around the
 * entity, prints collision flags/positions to the BG command buffer, and runs
 * a two-state (init / active) movement state machine with input-driven
 * horizontal motion, jumping and gravity, then updates camera and OAM.
 * (based on https://decomp.me/scratch/UoIYN)
 *
 * @param param_0 Entity data
 */
void sub_080370F0(struct EwramData_EntityData *param_0)
{
    ...
    param_0->unk_53D_2 = 1;
    temp_r8 = GetEntityRoomYPositionInteger(param_0);
    temp_r5 = GetEntityRoomXPositionInteger(param_0);

    sp24 = gEwramData->inputData.playerHeldInput >> 1;
    sp24 &= 1;
    sp14 = sub_08001E58(temp_r5, temp_r8, sp24);
    sp18 = sub_08001E58(temp_r5 - 8, temp_r8 + 1, sp24);
    sp1C = sub_08001E58(temp_r5 + 8, temp_r8 + 1, sp24);
    sp20 = sub_08001CCC(temp_r5 - 8, temp_r8 - 0x20, 0);
    temp_sl = sub_08001CCC(temp_r5 + 8, temp_r8 - 0x20, 0);

    temp_r8 = GetEntityRoomYPositionInteger(param_0);
    temp_r5 = GetEntityRoomXPositionInteger(param_0);
    temp_r6_2 = sub_08001A00(temp_r5, temp_r8 + 1);

    sprintf(sp4, "0x%02x", temp_r6_2);
    BgCmdBuffer_WriteString(2, 2, 0xF, (u8 *) sp4);

    sprintf(sp4, sUnk_080E22E8, temp_r5, temp_r8);
    BgCmdBuffer_WriteString(3, 3, 0xF, (u8 *) sp4);
    BgCmdBuffer_WriteString(3, 4, 0xF, (u8 *) sp4);

    var_r2 = 0;
    if (sub_080370F0_inline_0(temp_r6_2) || sub_080370F0_inline_1(temp_r6_2))
    {
        if (temp_r6_2 & 8)
        {
            if (temp_r6_2 & 1)
    ...
    var_0 = temp_r6_2 >> 6;
    sprintf(sp4, sUnk_080E22F0, var_r2, var_r3, var_0);
    BgCmdBuffer_WriteString(3, 4, 0xF, sp4);

    switch (param_0->unk_4EE)
    {
        case 0:
            temp_r4_6 = sub_0803B800((u8 *)0x081CF0DC, 0x10000);
            sub_0803C7B4((u8 *)0x0820B11C, 0, 1, 1);
            sub_0803B924(param_0, (void *)0x08231578, temp_r4_6, 1);
            ...
            param_0->unk_4EE += 1;
            param_0->unk_540 = 0x10;
            sub_08037070(param_0);
            break;

        case 1:
        {
            struct EwramData **pe = &gEwramData;
            struct EwramData *e = *pe;
            param_0->unk_534.unk_534_32 = 0;
            if (e->inputData.playerHeldInput & 0x20)
            {
                param_0->unk_524.unk_524_32 -= param_0->unk_52C.unk_52C_32;
                param_0->unk_534.unk_534_32 = -param_0->unk_52C.unk_52C_32;
                param_0->unk_53C_6 = 1;
            }
            if (gEwramData->inputData.playerHeldInput & 0x10)
            {
                param_0->unk_524.unk_524_32 += param_0->unk_52C.unk_52C_32;
                param_0->unk_534.unk_534_32 = param_0->unk_52C.unk_52C_32;
                param_0->unk_53C_6 = 0;
            ...
            // TODO: is double check real?
            if (param_0->unk_4F4.unk_4F4_32 == 1)
            {
                if ((param_0->unk_4F4.unk_4F4_32 == 1) && (gEwramData->inputData.playerNewInput & 1))
                {
                    param_0->unk_4F4.unk_4F4_32 = 2;
                    param_0->unk_530.unk_530_32 = -0x40000;
                    param_0->unk_538.unk_538_32 = 0;
                }
            }
            if ((gEwramData->inputData.playerNewInput & 1) && (gEwramData->inputData.playerHeldInput & 0x40))
            {
                param_0->unk_4F4.unk_4F4_32 = 1;
                param_0->unk_530.unk_530_32 = -0xA0000;
                param_0->unk_538.unk_538_32 = 0;
            }

            if (param_0->unk_4F4.unk_4F4_32 == 0)
            {
                if (sp18 == 0)
                {
                    if (sp1C == 0)
                ...
                if (param_0->unk_4F4.unk_4F4_32 == 0)
                {
                    ...
                    {
                        param_0->unk_4F4.unk_4F4_32 = 1;
                        param_0->unk_530.unk_530_32 = -0x52000;
                        param_0->unk_538.unk_538_32 = 0;
                    }
                    if (param_0->unk_4F4.unk_4F4_32 == 0)
                    {
                        goto here; // should be deleted when rest of code figured out
                        param_0->unk_528.unk_528_32 += param_0->unk_52C.unk_52C_32;
                        break;
                    }
                }
            }
            ...
            if (param_0->unk_530.unk_530_32 < 0)
            {
                if ((sp20 != 0) || (temp_sl != 0))
                {
                    param_0->unk_528.unk_528_16.unk_52A += (sp20 == 0) ? temp_sl : sp20;
                    param_0->unk_530.unk_530_32 = 0;
                }
            }

            if (param_0->unk_530.unk_530_32 < -0x4000)
            {
                if (!(gEwramData->inputData.playerHeldInput & 1))
                {
                    param_0->unk_530.unk_530_32 = -0x4000;
                    param_0->unk_538.unk_538_32 = -0x2000;
                }
            }
            if (param_0->unk_530.unk_530_32 < 0x2000)
            {
                param_0->unk_530.unk_530_32 += 0x2000;
            }
            if (param_0->unk_530.unk_530_32 > -0x20000 && param_0->unk_530.unk_530_32 < 0x2000)
            {
                if (gEwramData->inputData.playerHeldInput & 1)
                {
                    param_0->unk_538.unk_538_32 -= 0x800;
                    if (param_0->unk_538.unk_538_32 < -0x2800)
                    {
            ...
            if (param_0->unk_530.unk_530_32 > 0)
            {
                ...
                param_0->unk_538.unk_538_32 += 0x400;
                if (param_0->unk_538.unk_538_32 > 0x1000)
                {
                    param_0->unk_538.unk_538_32 = 0x1000;
                }
            }
            ...
            temp_r5 = GetEntityRoomXPositionInteger(param_0);
            sp14 = sub_08001E58(temp_r5, temp_r8, sp24);
            if ((gUnk_03002CB0.unk_100C & 3) == 3)
            {
                if ((sub_08001C1C(temp_r5, temp_r8 - 0x20) == 0) && (sub_08001C1C(temp_r5, temp_r8 - 0x10) == 0))
                {
                    param_0->unk_528.unk_528_16.unk_52A += sp14;
            ...
            if (sp14 == 0)
            {
                ...
                {
                    temp_r1_9 = sub_080020D8(temp_r5 + 8, temp_r8, sp24);
                    if (temp_r1_9 != 0)
                    {
                        param_0->unk_524.unk_524_16.unk_526 = (s16)param_0->unk_524.unk_524_16.unk_526 + temp_r1_9;
                        param_0->unk_524.unk_524_16.unk_524 = 0;
                    }
                }
                if (param_0->unk_534.unk_534_32 < 0)
                {
                    temp_r1_10 = sub_0800210C(temp_r5 - 8, temp_r8, sp24);
                    if (temp_r1_10 != 0)
                    {
                        param_0->unk_524.unk_524_16.unk_526 = (s16)param_0->unk_524.unk_524_16.unk_526 + temp_r1_10;
                        param_0->unk_524.unk_524_16.unk_524 = 0;
                    }
                }
            }

            if (((sp14 << 0x10) != 0) && (param_0->unk_530.unk_530_16.unk_532 >= 0))
            {
                param_0->unk_528.unk_528_16.unk_528 = 0;
                param_0->unk_530.unk_530_32 = 0;
                param_0->unk_538.unk_538_32 = 0;
    ...
    if (param_0->unk_534.unk_534_32 > 0)
    {
        temp_r1_11 = sub_080020D8(temp_r5 + 8, temp_r8 - 0x10, sp24);
        if (temp_r1_11 != 0)
        {
            param_0->unk_524.unk_524_16.unk_526 = (s16)param_0->unk_524.unk_524_16.unk_526 + temp_r1_11;
            param_0->unk_524.unk_524_16.unk_524 = 0;
        }
    }
    if (param_0->unk_534.unk_534_32 < 0)
    {
        temp_r1_12 = sub_0800210C(temp_r5 - 8, temp_r8 - 0x10, sp24);
        if (temp_r1_12 != 0)
        {
            param_0->unk_524.unk_524_16.unk_526 = (s16)param_0->unk_524.unk_524_16.unk_526 + temp_r1_12;
            param_0->unk_524.unk_524_16.unk_524 = 0;
        }
    }
    ...
    param_0->unk_4F1 += 1;
    sub_0803FBBC(1, ((s16) param_0->unk_524.unk_524_16.unk_526 - 0x78) << 0x10, (param_0->unk_528.unk_528_16.unk_52A - 0x70) << 0x10);
    sub_08000F60(1);
    sub_0800D288(0);
