...
_08053AEC:
	...
	ldr r2, _08053B7C @ =EntityUpdateNothing
	movs r0, #0x1b
	movs r1, #0x48
	bl EntityCreateInRange
	adds r4, r0, #0
...
_08053B7C: .4byte EntityUpdateNothing
...
_0805468C:
	...
	adds r0, r5, #0
	bl sub_08054E38
	ldr r6, _08054740 @ =EntityUpdateNothing
	movs r0, #0x1b
	movs r1, #0x48
	adds r2, r6, #0
	bl EntityCreateInRange
...
_08054736:
	...
	bx r0
	.align 2, 0
_08054740: .4byte EntityUpdateNothing
...
_08054EA4:
	...
	movs r0, #0x1b
	movs r1, #0x48
	ldr r2, _08054EEC @ =EntityUpdateNothing
	bl EntityCreateInRange
	adds r4, r0, #0
	cmp r4, #0
	beq _08054F4C
...
_08054EEC: .4byte EntityUpdateNothing
_08054EF0:
	adds r1, r4, #0
	adds r1, #0x42
	ldrh r0, [r1]
...
_08054FA8:
	movs r0, #0x1b
	movs r1, #0x48
	ldr r2, _08055064 @ =EntityUpdateNothing
	bl EntityCreateInRange
	adds r4, r0, #0
	cmp r4, #0
	beq _08055044
...
_08055064: .4byte EntityUpdateNothing
...
_08055C02:
	movs r0, #0x1b
	movs r1, #0x48
	ldr r2, _08055CA4 @ =EntityUpdateNothing
	bl EntityCreateInRange
	adds r4, r0, #0
	cmp r4, #0
	beq _08055C88
...
_08055CA4: .4byte EntityUpdateNothing
...
_080560A0:
	movs r0, #0x1b
	movs r1, #0x48
	ldr r2, _080560D0 @ =EntityUpdateNothing
	bl EntityCreateInRange
	adds r4, r0, #0
	cmp r4, #0
	beq _08056114
...
_080560D0: .4byte EntityUpdateNothing
...
_080579D8:
	...
	cmp r0, #9
	bgt _08057A80
	ldr r2, _08057A90 @ =EntityUpdateNothing
	movs r0, #0x1b
	movs r1, #0x48
	bl EntityCreateInRange
	adds r6, r0, #0
...
_08057A80:
	...
	bx r0
	.align 2, 0
_08057A90: .4byte EntityUpdateNothing
